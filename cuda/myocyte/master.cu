...
void master(float timeinst, float* initvalue, float* parameter, float* finalvalue, float* com,

float* d_initvalue, float* d_finalvalue, float* d_params, float* d_com, bool unified) {
  ...
  kernel_fin(initvalue, initvalue_offset_ecc, initvalue_offset_Dyad, initvalue_offset_SL,
      initvalue_offset_Cyt, parameter, finalvalue, com[0], com[1], com[2]);
